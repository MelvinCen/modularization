...
import com.melvin.base.base_interface.IFragment;
...
public abstract class BaseLazyLoadFragment<P extends IPresenter> extends Fragment implements IFragment {
...
//----------------------------------子类可以复写的方法------------------------------------------------
    ...
    public void showLoading() {
        ...
        if (loadingProgressDialog == null) {
            loadingProgressDialog = LoadingDialogBuilder.init(getContext(), null);
        }
    ...
    /**
     * 调用宿主BaseActivity的avoidDoubleClick
     *
     * @param view
     * @param consumer
     */
    public void avoidDoubleClick(View view, Consumer<Unit> consumer) {
        if (activityWeakReference.get() != null) {
            ((BaseActivity) activityWeakReference.get()).avoidDoubleClick(view, consumer);
        }
    }

    /**
     * 调用宿主BaseActivity的textChangeListener
     *
     * @param view
     * @param consumer
     */
    public void textChangeListener(TextView view, Consumer<CharSequence> consumer) {
        if (activityWeakReference.get() != null) {
            ((BaseActivity) activityWeakReference.get()).textChangeListener(view, consumer);
        }
    }
     ...
     * @return
     */
    public AppCompatActivity getItsActivity() {
